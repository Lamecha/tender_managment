...
//$result = $obj->common_update_allcolm('tender','created_by','updated_by');
$result = $obj->common_update_allcolm2_tender('history_tender','created_by','created_table','updated_by','updated_table');
?>
<?php
...
<title>Del History Tender : Rainbow Tender Managment</title>
...
<div id="index-main">
<span id="title_work_page">Update/Delete Tender</span>
<div id="working-sub-main">
<div id="working-panel">
<table id="multipels" class="attachz">
<tr><th width="200">Tender Number</th><th width="200">Created by</th><th width="200">Updated by</th><th width="70">Edit</th><th width="70">Delete</th><th width="70">View</th>
...
<td style="text-align:center" class="basic_text_style"><label><font style="font-size:12px"><?=$v['tender_number']; ?></font></label></td>
...
<td width="100" style="text-align:center"><a href="history.php?val=<?=$v['id'];?>"><img src="main_images/edit.png" /></td></a>
<td width="100" style="text-align:center"><a href="#" id="<?=$v['id'];?>" class="delete"><img src="main_images/delete.png" /></a></td>
<td width="100" style="text-align:center"><a href="All_profile_view_files/tender_History_profile.php?val=<?=$v['id'];?>&pid=<?=$_GET['pid'];?>" target="_blank"><img src="main_images/view.png" /></a></td>
