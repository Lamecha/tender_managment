...
<title>Information of <?php print_r($result['employee_first_name']); ?> <?php print_r($result['employee_last_name']) ?></title>
</head>

<body>
<div id="wrapper">
<p><input type="button" class="print" value="Print" /></p>
<p style="font-size:19px;">Name : <?php print_r($result['employee_first_name']); ?> <?php print_r($result['officer_last_name']) ?> [Employee]</p>
<img src="../photo/employee/thumb/<?=$result['employee_photo'];?>" style="float:left;" />
<table width="800" border="1">
  <tr>
   ...
   <tr>
    ...
    <th width="589" scope="col"><?php print_r($result['employee_user_name']); ?></th>
  </tr>
  <tr>
    <th width="157" scope="col">Pin Code</th>
    <th width="589" scope="col"><?php print_r($result['employee_pin']); ?></th>
  </tr>
   <tr>
    <th width="157" scope="col">Email</th>
    <th width="589" scope="col"><?php print_r($result['employee_mail']); ?></th>
  </tr>
   <tr>
    <th width="157" scope="col">Mobile</th>
    <th width="589" scope="col"><?php print_r($result['employee_mobile']); ?></th>
  </tr>
   <tr>
    <th width="157" scope="col">Address</th>
    <th width="589" scope="col"><?php print_r($result['employee_address']); ?></th>
  </tr>
