...
$result = $obj->common_update_allcolm2_tender('tender','created_by','created_table','updated_by','updated_table');
?>
<?php
...
<title>Update Tender : Rainbow Tender Managment</title>
...
<tr><th width="200">Tender Number</th><th width="200">Created by</th><th width="200">Updated by</th><th width="70">Edit</th><th width="70">Delete</th>
<th width="70">View</th>
</tr>
<?php 
foreach($result as $v)
...
<td width="100" style="text-align:center"><a href="fill_tender.php?val=<?=$v['id'];?>"><img src="main_images/edit.png" /></td></a>
<td width="100" style="text-align:center"><a href="#" id="<?=$v['id'];?>" class="delete"><img src="main_images/delete.png" /></a></td>
<td width="100" style="text-align:center"><a href="All_profile_view_files/tender_profile.php?val=<?=$v['id'];?>&pid=<?=$_GET['pid'];?>" target="_blank"><img src="main_images/view.png" /></a></td>
</tr>
