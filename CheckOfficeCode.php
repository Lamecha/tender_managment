...
if($validateId=="office_code")
{
	if($ajaxobj->Duplicate_Pin_Common($validateValue,"office","office_code"))
	{		// validate??
...
{
	if($ajaxobj->Duplicate_Pin2_Common($validateValue,"office","office_code",$validateId))
	{		// validate??
		$arrayToJs[1] = true;			// RETURN TRUE
		echo json_encode($arrayToJs);			// RETURN ARRAY WITH success
