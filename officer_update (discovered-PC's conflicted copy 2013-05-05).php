...
<td width="100" style="text-align:center"><a href="All_profile_view_files/officer_profile.php?val=<?=$v['id'];?>&pid=<?=$_GET['pid'];?>" target="_blank"><img src="main_images/view.png" /></a></td>
</tr>
