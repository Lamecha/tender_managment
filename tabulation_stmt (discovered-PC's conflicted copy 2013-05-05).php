...
<title>tabulation Statement of Financial Bids for Tender No: 79131842 ::  Due Date/Time : 08/02/13 14:25 </title>
</head>
...
<p style="font-size:19px;">Total Value of Tender (INR): <?php $total_value=$obj->CalculationOfTenderValue($_GET['id']);
print_r($total_value);
...
<p style="text-align:left;">Product Description : <?=$pd['item_discription'];?></p>
 ...
 <?php if(is_array($firms_in_products))
 {
 ?>
 <table width="1200" border="1" style="page-break-inside:auto;">
  <tr>
    ...
    <th width="102" scope="col">Final Rate</th>
...
<?php } 
 ...
 {
	 ?>
     <th scope="colps" colspan="13">Firms are not registered in this product</th>
     <?php
...
<table width="1200" border="1">
  ...
  <tr>
    ...
    <tr>
    <th class="last_border">Delivery Period :</th>
    <td><?=$meenukew['delperod'];?></td>
    </tr>
    
    <tr>
    <th class="last_border">&nbsp;Delivery Schedule :</th>
    <td><?=$meenukew['delschedule'];?></td>
    </tr>
   
    <tr>
    <th class="last_border">Remark :</th>
    <td><?=$meenukew['remark'];?></td>
    </tr>
   
    <tr>
    <th class="last_border">SPI Note :</th>
    <td><?=$meenukew['spinate'];?></td>
    </tr>
    </table>
    </td>
