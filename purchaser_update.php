...
//$result = $obj->common_update_allcolm('create_purchaser','created_by','updated_by');
$result = $obj->common_update_allcolm2_order_by_short('create_purchaser','created_by','created_table','updated_by','updated_table','purchaser_name');
...
<title>Update Purchaser : Rainbow Tender Managment</title>
...
<script type="text/javascript">
	...
	$(document).ready(function()
	{
		$('table#multipels td a.delete').click(function()
		{
			...
			var tablename="create_purchaser";
			var subtable1="main_consignee";
			var subcolmn1="main_csign_purchaser";
			var subtable2="tender";
			var subcolmn2="tender_purchaser";
			...
			if (confirm("Are you sure you want to delete this row?"))
			{
				...
				$.ajax(
				{
					   ...
					   url: "MainAjax.php?delid="+delid+"&tablename="+tablename+"&subtable1="+subtable1+"&subcolmn1="+subcolmn1+"&subtable2="+subtable2+"&subcolmn2="+subcolmn2,
					   data: data,
					   cache: false,
					   ...
					   success: function(data)
					   {
							...
							parent.fadeOut('slow', function() {$(this).remove();});
							   ...
							   {
								  alert("Record can't be deleted \n Please check Consignee or tender's purchasers.");
							   }
						}
...
<div id="index-main">
<span id="title_work_page">Update/Delete Purchaser</span>
...
<td style="text-align:center" class="basic_text_style"><label><font style="font-size:12px"><?=$v['purchaser_name']; ?></font></label></td>
...
<td width="100" style="text-align:center"><a href="create_purchaser.php?val=<?=$v['id'];?>"><img src="main_images/edit.png" /></td></a>
<td width="100" style="text-align:center"><a href="#" id="<?=$v['id'];?>" class="delete"><img src="main_images/delete.png" /></a></td>
<td width="100" style="text-align:center"><a href="All_profile_view_files/purchaser_profile_view.php?val=<?=$v['id'];?>" target="_blank"><img src="main_images/edit.png" /></a></td>
</tr>
