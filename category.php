...
<title>Category : Rainbow Tender Managment</title>
...
<div id="index-main">
<span id="title_work_page">Category</span>
<div id="working-sub-main">
<div id="working-panel">

<table id="working-form">
<form>
<tr><td><label for="cat_name">Category Name:</label></td>
<td><input type="text" name="cat_name" id="cat_name" /></td></tr>
<tr><td>&nbsp;</td>
