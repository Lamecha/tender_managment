...
$result = $obj->common_update_allcolm2_tender('history_po','created_by','created_table','updated_by','updated_table');
?>
<?php
...
<title>Edit PO History : Rainbow Tender Managment</title>
...
<div id="index-main">
<span id="title_work_page">Update/Delete PO History</span>
...
<td width="100" style="text-align:center"><a href="history_po.php?val=<?=$v['id'];?>"><img src="main_images/edit.png" /></td></a>
<td width="100" style="text-align:center"><a href="#" id="<?=$v['id'];?>" class="delete"><img src="main_images/delete.png" /></a></td>
<td width="100" style="text-align:center"><a href="All_profile_view_files/Po_HISTORY_profile.php?val=<?=$v['id'];?>&pid=<?=$_GET['pid'];?>" target="_blank"><img src="main_images/view.png" /></a></td>
</tr>
