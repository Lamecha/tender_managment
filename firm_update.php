...
//$result = $obj->common_update_allcolm('consignee','created_by','updated_by');
$result = $obj->common_update_allcolm2_order_by_short('consignee','created_by','created_table','updated_by','updated_table','csign_firm_name');
?>
<?php
...
<title>Update Firm : Rainbow Tender Managment</title>
...
//var $k=jQuery.noConflict();
	...
	$(document).ready(function()
	{
		$('table#multipels td a.delete').click(function()
		{
			...
			var tablename="consignee";
			var subtable1="tender_firms";
			var subcolmn1="firm";
...
<td style="text-align:center" class="basic_text_style"><label><font style="font-size:12px"><?=$v['csign_firm_name']; ?></font></label></td>
...
<td width="100" style="text-align:center"><a href="firm_registration.php?val=<?=$v['id'];?>"><img src="main_images/edit.png" /></td></a>
<td width="100" style="text-align:center"><a href="#" id="<?=$v['id'];?>" class="delete"><img src="main_images/delete.png" /></a></td>
<td width="100" style="text-align:center"><a target="_blank" href="firm_profile_view.php?val=<?=$v['id'];?>"><img src="main_images/edit.png" /></a></td>
</tr>
