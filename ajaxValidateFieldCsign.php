...
if($validateId=="csign_short_name")
{
	if($ajaxobj->Duplicate_Pin_Common($validateValue,"consignee","csign_short_name"))
	{		// validate??
...
{
	if($ajaxobj->Duplicate_Pin2_Common($validateValue,"consignee","csign_short_name",$validateId))
	{		// validate??
		$arrayToJs[1] = true;			// RETURN TRUE
		echo json_encode($arrayToJs);			// RETURN ARRAY WITH success
