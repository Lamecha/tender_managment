...
<!------------------------------------------------------>
 <?php if($result_product[0]!='')
 {
     ...
     <tr>
 <th style="width:200px; border:1px solid #333;">Person Name</th> 
 <th style="width:200px; border:1px solid #333;">Pan No.</th>
...
foreach($result_product as $mj) 
	{
      ...
      <td style="border:1px solid #333;"><?=$mj['csign_director'];?></td>
    <td style="border:1px solid #333;"><?=$mj['csign_pan_number'];?></td>
    <td style="border:1px solid #333;"><?=$mj['csign_tel_number'];?></td>
