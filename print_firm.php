...
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($tender_details['tender_number']); ?></td>
</tr>
<tr>
<td style="width:140px;">Tender Type:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php echo $status;?></td>
</tr>
<tr>
<td style="width:140px;">Purchaer:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($purchaser_detail['purchaser_short_name']); ?></td>
</tr>
<tr>
<td style="width:140px;">Due Date:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php $new_date=$obj->Date_Format($tender_details['tender_due_date']); ?>
<?php echo $new_date; ?>
</td>
</tr>
<tr>
<td style="width:140px;">Due Time:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($tender_details['tender_time']); ?></td>
</tr>
<tr>
<td style="width:140px;">EMD:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($tender_details['tender_emd']); ?></td>
</tr>
<tr>
<td style="width:140px;">TDC:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($tender_details['tender_tdc']); ?></td>
</tr>
</table>
<table id="item_detail">
<tr>
<td style="width:140px;">Item Name:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($product_details['item_name']); ?></td>
</tr>
<tr>
<td style="width:140px;">Item Discription:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($product_details['item_discription']); ?></td>
</tr>
<tr>
<td style="width:140px;">Consignee:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($product_details['main_csign_short_name']); ?></td>
</tr>
<tr>
<td style="width:140px;">Quantity:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php print_r($product_details['quantity']); ?>
</td>
</tr>
<tr>
<td style="width:140px;">Unit:</td>
<td style="width:320px; word-wrap:break-word;">&nbsp;<?php echo $unit_new =$obj->unit($product_details['unit']); ?></td>
</tr>
</table>
</div>
