...
select_box.setAttribute('onchange','IfSelectOtherThenTitle(this.id)');
select_box.setAttribute("style","width:120px;height:30px;border:1px solid #333;")
select_box.innerHTML="<option value=''>Please select</option><option value='1'>NIT</option><option value='2'>Specification</option><option value='3'>Drawing Copy</option><option value='4'>Annulav</option><option value='5'>Special Caution</option><option value='10'>Others</option>";
...
function Add_Quoto2_New()
{
	...
	td15.innerHTML = "<input type='text' id='remark_"+counter+"' name='remark[]' readonly='readonly'/>";
...
select_box.setAttribute('onchange','IfSelectOtherThenTitle(this.id)');
select_box.setAttribute("style","width:120px;height:30px;border:1px solid #333;")
select_box.innerHTML="<option value=''>Please select</option><option value='1'>Finantial Tabulation</option><option value='2'>Technical Tabulation</option><option value='3'>Mannual Tabulation</option><option value='10'>Others</option>";
