...
<a style="text-decoration:none;color:#000000;" href="#" title="<?php echo $display_dis; ?>"><?php echo $display_display; ?></a>
	...
	{ if($dday=='Tender Lapsed') { ?> <a href="#" style="text-decoration:none;"><img src="main_images/no-proceed.png"/></a> <?php } else { ?><a href="tender_quot_new.php?id=<?=$v['id'];?>&val=<?php echo $madeStyle; ?>" style="text-decoration:none; cursor:pointer; color:#000;"><img src="main_images/proceed.png"/></a><?php } }?></td>
    <td style="border:0px solid #666; height:35px;">
