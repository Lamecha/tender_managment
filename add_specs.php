...
if(isset($_POST['submit']) && $_POST['key']==$_SESSION['key'])
{
 ...
 //----ATTACHEMENTS_END-----
	if(isset($_GET['val']) & $_GET['val']!="")
	{
		...
		$update_result=$obj->Specification_update($_POST['specification_no'],$_POST['part'],$_POST['revision'],$_POST['reaffirmed'],$_POST['year'],$finalName,$name,$result['id'],$_SESSION['pin_id'],$_SESSION['pin_table'],$_POST['issued'],$_POST['other_issued']);
		if($update_result == 1)
		{
	...
	else
	{
		...
		{
		$opt=$obj->specification_registration($_POST['specification_no'],$_POST['part'],$_POST['revision'],$_POST['reaffirmed'],$_POST['year'],$finalName,$name,$_SESSION['pin_id'],$_SESSION['pin_table'],$_POST['issued'],$_POST['other_issued']);
...
<tr><td><label for="specsno">Specification No</label></td>
<td><input type="text" name="specification_no" id="specification_no" class="Xvalidate[Xrequired"  value="<?php print_r($result['specification_no']); ?>" /></td></tr>
