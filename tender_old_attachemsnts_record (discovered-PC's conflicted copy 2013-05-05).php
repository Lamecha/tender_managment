...
if(isset($_POST['save']))
{
	...
	if($result==1)
	{
		?>
        <script>
       window.location="tender_old_attachemsnts_record.php?val=<?=$_GET['val'];?>&table=<?=$_GET['table'];?>&field=<?=$_GET['field'];?>";
		</script>
        <?php
...
function Edit_Directors(ss)
{
	...
	window.location="tender_old_attachemsnts_record.php?val=<?=$_GET['val'];?>&table=<?=$_GET['table'];?>&field=<?=$_GET['field'];?>&tb_row="+ss;
}
</script>
<script>
