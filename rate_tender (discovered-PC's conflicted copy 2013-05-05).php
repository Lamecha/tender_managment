...
<!--------------------------------->
<!---------------Availabel Products------------------->
<div id="right_info" style="float:left; width:400px;height:auto;background:#f6f6f6; border:2px solid #efefef; margin:5px 5px 10px 5px;">
<div id="old_info_span" style="min-height:40px; height:auto; padding-top:10px; border:none;">
<span style="margin-left:0px;font-size:18px; margin-top:10px;width:380px;word-wrap:break-word; border-bottom:1px solid #333;">
...
<!--------------------DownLoad Files-------------------->
<div id="sub_right_info" style="float:left; width:400px;height:auto;background:#f6f6f6; border:2px solid #efefef; margin:5px 5px 10px 5px;">
<div id="old_info_span" style="min-height:40px; height:auto; padding-top:10px; border:none;">
<span style="margin-left:0px;font-size:18px; margin-top:10px;width:380px;word-wrap:break-word; border-bottom:1px solid #333;">
...
<td>
<input type="text" id="remark_0" name="remark[]" value="<?php print_r($record_update['remark']); ?>"  />
</td>
<td>
<?php
