...
if($validateId=="specification_no")
{
	if($ajaxobj->Duplicate_Pin_Common($validateValue,"specification","specification_no"))
	{		// validate??
...
{
	if($ajaxobj->Duplicate_Pin2_Common($validateValue,"specification","specification_no",$validateId))
	{		// validate??
		$arrayToJs[1] = true;			// RETURN TRUE
		echo json_encode($arrayToJs);			// RETURN ARRAY WITH success
