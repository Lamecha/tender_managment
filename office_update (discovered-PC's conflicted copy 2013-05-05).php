...
$result = $obj->common_update_allcolm2_order_by_short('office','created_by','created_table','updated_by','updated_table','office_code');
?>
<?php
...
<td style="text-align:center" class="basic_text_style"><label><font style="font-size:12px"><?=$v['office_code']; ?></font></label></td>
...
<td width="100" style="text-align:center"><a href="office.php?val=<?=$v['id'];?>"><img src="main_images/edit.png" /></td></a>
<td width="100" style="text-align:center"><a href="#" id="<?=$v['id'];?>" class="delete"><img src="main_images/delete.png" /></a></td>
<td width="100" style="text-align:center"><a href="All_profile_view_files/office_profile.php?val=<?=$v['id'];?>&pid=<?=$_GET['pid'];?>" target="_blank"><img src="main_images/view.png" /></a></td>
</tr>
