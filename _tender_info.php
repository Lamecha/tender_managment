...
foreach($attachments as $nj)
{
	...
	$sm++;
	?>
   <tr><td style="color:#009;"><?php echo $sm; ?> <a style="color:#009;" href="attachements/tender_attach/<?=$nj['file'];?>" target="_new"><?=$title_value;?>/<?=$nj['other_title'];?> [<?=$nj['file_real_name'];?>]</a></td></tr>
    <?php
