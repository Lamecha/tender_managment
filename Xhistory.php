...
<td><input type="text" name="tender_number" id="XpresidentsServerInput" class="XAutoFillTender" value="<?php print_r($result['tender_number']); ?>" onKeyUp="XCheckTenderNumber(this.value)"/></td><td><span id="tender_number_span"><img id="loader_no" style="display:none;" src="main_images/indicator.gif" /></span></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
